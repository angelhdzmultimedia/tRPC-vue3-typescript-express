...
export type inferQueryOutput<
  ...
  TRouteKey extends keyof TRouter['_def']['queries']
...
export type inferQueryInput<
  TRouter extends AnyRouter,
  TRouteKey extends keyof TRouter['_def']['queries']
> = inferProcedureInput<TRouter['_def']['queries'][TRouteKey]>;
...
export type TQueryValues<TRouter extends AnyRouter> = inferProcedures<
  TRouter['_def']['queries']
>;

export type TPath<TRouter extends AnyRouter> = keyof TQueryValues<TRouter> &
  string;
